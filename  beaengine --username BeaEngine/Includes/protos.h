...
void __stdcall _rEAX(ARGTYPE*);
void __stdcall _rECX(ARGTYPE*);
void __stdcall _rEDX(ARGTYPE*);
void __stdcall _rEBX(ARGTYPE*);
void __stdcall _rESP(ARGTYPE*);
void __stdcall _rEBP(ARGTYPE*);
void __stdcall _rESI(ARGTYPE*);
void __stdcall _rEDI(ARGTYPE*);
...
// ====================================== opcodes_AES
void __stdcall aesimc(PDISASM);
void __stdcall aesdec(PDISASM);
void __stdcall aesdeclast(PDISASM);
void __stdcall aesenc(PDISASM);
void __stdcall aesenclast(PDISASM);
void __stdcall aeskeygen(PDISASM);

// ====================================== opcodes_CLMUL
void __stdcall pclmulqdq_(PDISASM);
